...
class SurakkhaRepository(private val context: Context) {
    ...
    private fun getOfflineSimplifiedDocument(title: String, rawContent: String): SimplifiedDocument {
        ...
        val mainTopic = if (text.contains("স্কুল") || text.contains("শিক্ষা")) {
            "মাধ্যমিক ও উচ্চ মাধ্যমিক স্তরের শিক্ষার্থীদের জন্য সরকারি বৃত্তিমূলক উন্নয়ন প্রশিক্ষণ প্রকল্প ও অনুদান সংক্রান্ত বিশেষ পরিপত্র।"
        } else if (text.contains("দুর্যোগ") || text.contains("বন")) {
            "দেশজুড়ে আসন্ন বর্ষা ও জোয়ারের ঝুঁকি হ্রাসকরণে দুর্যোগ ব্যবস্থাপনা ও ত্রাণ মন্ত্রণালয়ের বিশেষ সতর্কবার্তা।"
        } else {
            "জনসাধারণের কল্যাণে গণপ্রজাতন্ত্রী বাংলাদেশ সরকার কর্তৃক জারিকৃত গুরুত্বপূর্ণ সাধারণ প্রজ্ঞাপন।"
        }
